...
def create_tray_size_class(tray_size_class_input: TraySizeClassInput, session: Session = Depends(get_session)):
    """
...
def update_tray_size_class(
    id: int, tray_size_class: TraySizeClassUpdateInput, session: Session = Depends(get_session)
):
    """
