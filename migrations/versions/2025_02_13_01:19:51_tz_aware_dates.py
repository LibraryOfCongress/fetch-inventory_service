...
Revision ID: 2025_02_13_01:19:51
Revises: 2025_02_12_23:48:29
Create Date: 2025-02-13 01:19:51.152283
...
revision: str = '2025_02_13_01:19:51'
down_revision: Union[str, None] = '2025_02_12_23:48:29'
...
def upgrade() -> None:
    ...
    op.alter_column('item_withdrawals', 'update_dt',
               ...
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('items', 'accession_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('items', 'withdrawal_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('items', 'scanned_for_refile_queue_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    ...
    op.alter_column('non_tray_item_withdrawals', 'update_dt',
               ...
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('non_tray_items', 'accession_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('non_tray_items', 'withdrawal_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('non_tray_items', 'shelved_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('non_tray_items', 'scanned_for_refile_queue_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    ...
    op.alter_column('tray_withdrawals', 'update_dt',
               ...
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('trays', 'accession_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('trays', 'shelved_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    op.alter_column('trays', 'withdrawal_dt',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
    ...
    op.alter_column('trays', 'update_dt',
               ...
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('users', 'fetch_auth_expiration',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.TIMESTAMP(timezone=True),
               existing_nullable=True)
