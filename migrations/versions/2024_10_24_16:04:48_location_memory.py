...
Revision ID: 2024_10_24_16:04:48
...
revision: str = '2024_10_24_16:04:48'
down_revision: Union[str, None] = '2024_10_16_12:33:26'
...
def upgrade() -> None:
    ...
    op.alter_column('shelf_positions', 'location',
               ...
               type_=sqlmodel.sql.sqltypes.AutoString(length=175),
...
def downgrade() -> None:
    ...
    op.alter_column('shelf_positions', 'internal_location',
               ...
               existing_nullable=True)
    op.alter_column('shelf_positions', 'location',
               existing_type=sqlmodel.sql.sqltypes.AutoString(length=175),
