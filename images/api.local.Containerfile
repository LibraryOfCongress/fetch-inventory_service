...
CMD ["gunicorn", "app.main:app", "-k", "uvicorn.workers.UvicornWorker", "--workers", "2", "--bind", "0.0.0.0:8001", "--ssl-keyfile", "app/saml/local/key.pem", "--ssl-certfile", "app/saml/local/cert.pem"]
