...
# RUN app/saml/develop/gen_self_signed_certs.sh
...
# CMD ["uvicorn", "app.main:app", "--host", "0.0.0.0", "--port", "8001", "--ssl-keyfile", "app/saml/develop/key.pem", "--ssl-certfile", "app/saml/develop/cert.pem"]
