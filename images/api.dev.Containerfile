...
RUN java -jar /code/schemaspy.jar -t pgsql -dp /code/postgresql.jar -o /code/schema-docs -u postgres -p postgres -db inventory_service -s public -host c2vldimsdb01.loctest.gov -port 5432
